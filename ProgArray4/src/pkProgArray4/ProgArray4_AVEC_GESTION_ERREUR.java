...
public class ProgArray4_AVEC_GESTION_ERREUR {

	public static void main(String[] args) {

			int iSaisie=0, iPositionTravail, iTab[]=new int[0], iSomme=0;
				...
				case "1": case "2": case "3":/*1-Ajouter un nombre au début, à la fin ou à un endroit spécifique du tableau
						...
						while(iSaisie<1)
						{
							...
							{//Modification
								...
								{
									JOptionPane.showMessageDialog(null, "Modifier un nombre à une position où il n'y a aucun nombre entré");
								}
							}
							if(Integer.parseInt(sSaisie)==3)//Supression
							{
								...
								{
									JOptionPane.showMessageDialog(null, "Supprimer un nombre à une position où il n'y a aucun nombre est vide");
								}
								break;
							}
						...
						if(!err)
						{
							...
							JOptionPane.showMessageDialog(null, "Le nombre "+iSaisie+" vient d'être "+sSortie+" à la position "+iPositionTravail);
						}
						iSaisie=0;
