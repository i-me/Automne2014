...
public class ClDate {
	...
	public void setiJour()
	{
		...
		{
			this.iJour=01;
			System.out.println("Le jour fournis n'était pas numérique, une valeur par défaut a été assignée");
			
		}
		catch(IllegalArgumentException err)
		{
			System.out.println("Nombre illégal fournis "+err.getMessage());
		}
		finally
		{
	...
	public void setiMois()
	{
		...
		{
			this.iMois=01;
			System.out.println("Le mois fournis n'était pas numérique, une valeur par défaut a été assignée");
		}
		catch(IndexOutOfBoundsException err)
		{
			this.iMois=01;
			System.out.println("Le mois fournis était invalide. Une valeur par défaut a été assignée");
		}
		finally
		{
